...
export {
  tsStyleForm as $tsStyleForm,
  tsStyleInput as $tsStyleInput,
  tsStyleSelect as $tsStyleSelect,
  tsStyleTextarea as $tsStyleTextarea,
  TsFormStyle,
  TsInputStyle,
  TsSelectStyle,
  TsTextAreaStyle,
