import{HP_HOST,css,unsafeCSS,html,PageViewElement,updateMetadata,SharedStyles,TsTypographyStyle,TsLayoutStyle,TsGridStyle,TsCard,TsButtonStyle}from"./ts-app.js";const TsFormStyle=css`
  :host {
    display: block;
  }
  .main-frame {
...
`;var tsStyleForm={TsFormStyle:TsFormStyle};const TsInputStyle=css`
  ts-input {
...
`;var tsStyleInput={TsInputStyle:TsInputStyle};const TsSelectStyle=css`
  ts-select {
    display: inline-block;
...
`;var tsStyleSelect={TsSelectStyle:TsSelectStyle};const TsTextAreaStyle=css`
  ts-textarea {
    display: inline-block;
    margin: 5px 0px 5px 0px;
  }
...
`;var tsStyleTextarea={TsTextAreaStyle:TsTextAreaStyle};const cdnHost=unsafeCSS(HP_HOST);class TSContact extends PageViewElement{static get styles(){return[SharedStyles,TsTypographyStyle,TsLayoutStyle,TsGridStyle,TsCard,TsButtonStyle,TsFormStyle,TsInputStyle,TsSelectStyle,TsTextAreaStyle,css`
      :host {
        display: block;
        padding: 0px;
      }
    ...
    `]}render(){updateMetadata({title:"Contact a WordPress Exxpert - Logical Phase",description:"We're experts at relocating WordPress"});const requestip=location.hostname,{_response,_state,_waiting}=this;return html`
...
FirstName:form.elements.first_name.value,LastName:form.elements.last_name.value,Email:form.elements.email.value,Subject:form.elements.type.value,Website:form.elements.website.value,Description:form.elements.description.value}),headers:{"Content-Type":"multipart/form-data; boundary=------------------------d74496d66958873e--"}})}/**
     ...
     */_didReceiveResponse(response){this._response=response;this._waiting=!1}}window.customElements.define("ts-contact",TSContact);export{tsStyleForm as $tsStyleForm,tsStyleInput as $tsStyleInput,tsStyleSelect as $tsStyleSelect,tsStyleTextarea as $tsStyleTextarea,TsFormStyle,TsInputStyle,TsSelectStyle,TsTextAreaStyle};