import{CDN_HOST_URL,unsafeCSS,css,html,PageViewElement,updateMetadata,SharedStyles,TsTypographyStyle,TsLayoutStyle,TsGridStyle,TsCard,TsButtonStyle}from"./ts-app.js";const cdnHost=unsafeCSS(CDN_HOST_URL);class TSPagespeed extends PageViewElement{static get styles(){return[SharedStyles,TsTypographyStyle,TsLayoutStyle,TsGridStyle,TsCard,TsButtonStyle,css`
      ...
      `]}render(){updateMetadata({title:"WordPress PageSpeed Optimization Service - Logical Phase",description:"We make slow WordPress lightning fast WordPress. Guaranteed"});return html`
