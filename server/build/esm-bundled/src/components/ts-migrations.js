      ...
      css`
        ...
        .hero {
          background: var(--app-reverse-text-color)
            url('/images/header/ts-migrations-header-opt.svg') no-repeat;
                ...
                <header class="ts-grid__column is-7 is-6__large is-1__large--offset">
                  <div class="fade-in content-set">
                    ...
                    <p class="ts-headline4 ts-why-hyperpress__intro-text">
                      Fast, safe, no interruption WordPress migrations.
                    </p>
                ...
                <div class="ts-grid--alternate ts-copy__inner ts-copy--60-40 ts-grid-row-start">
                  ...
                  >
                    <img
                      ...
                      src="/images/content/ts-migrations-van-200x200-opt.svg"
                      alt="Moving Existing Site to WordPress"
                    />
                  </div>
                  <div
                  ...
                  >
                    ...
                    <p>
                      We've moved hundreds of WordPress sites to new hosting. We know exactly what
                      needs to be done to eliminate downtime, protect your data, and complete all of
                      other tasks needed to make your move a stress free one.
                    </p>
                ...
                <div class="ts-grid--alternate ts-copy__inner ts-copy--60-40 ts-grid-row-start">
                  ...
                  >
                    <img
                      ...
                      src="/images/content/ts-migrations-towp-200x200-opt.svg"
                      alt="Safe, fast, no interruption WordPress migrations"
                    />
                  </div>
                  <div
                    class="ts-grid__col is-1__large--offset ts-copy__text is-7 is-6__large ts-grid-row-start"
                  >
                    ...
                    <p>
                      You've heard great things about WordPress, but your site was built using some
                      other software or content mangement system (CMS), and he idea of trying to
                      move your site into WordPress seems impossibly complex. Don't let that stop
                      you. We built migration tools that automate importing your content into a
                      brand new WordPress instance, quickly, safely, and without error. So, if
                      you're ready to move to WordPress, we can make it happen.
                    </p>
                    <div class="ts-content-header__link ts-element-align">
                      <a
                        href="/contact/"
            ...
            <section class="ts-copy">
              <div class="ts-grid--alternate ts-copy__inner ts-copy--two-column">
                <div class="ts-grid__col is-1__large--offset ts-copy__text is-6 is-5__large">
                  ...
                  <p>
                    PWAs load instantly even in spotty internet conditions. Users are notified if
                    they lose internet connection while continuing to browse your site with
                    confidence while avoiding lost sales!
                  </p>
                </div>
                <div class="ts-grid__col ts-copy__text is-6 is-5__large">
                  ...
                  <p>
                    ...
                    natural, pleaseing application look and feel. No more janking, confusing view
                    changes
                  </p>
                </div>
                <div class="ts-grid__col is-1__large--offset ts-copy__text is-6 is-5__large">
                  ...
                  <p>
                    A natural, inviting, immersive user experience where users can quickly find what
                    they need and convert interest to action.
                  </p>
                </div>
                <div class="ts-grid__col ts-copy__text is-6 is-5__large">
