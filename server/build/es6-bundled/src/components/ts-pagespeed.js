define(["./ts-app.js"],function(_tsApp){"use strict";const cdnHost=(0,_tsApp.unsafeCSS)(_tsApp.CDN_HOST_URL);class TSPagespeed extends _tsApp.PageViewElement{static get styles(){return[_tsApp.SharedStyles,_tsApp.TsTypographyStyle,_tsApp.TsLayoutStyle,_tsApp.TsGridStyle,_tsApp.TsCard,_tsApp.TsButtonStyle,_tsApp.css`
      ...
      `]}render(){(0,_tsApp.updateMetadata)({title:"WordPress PageSpeed Optimization Service - Logical Phase",description:"We make slow WordPress lightning fast WordPress. Guaranteed"});return _tsApp.html`
              ...
              <div class="ts-grid__column is-7 is-6__large is-1__large--offset">
                <header class="ts-grid__column is-7 is-6__large is-1__large--offset">
                  <div class="fade-in content-set">
                    <h1 class="ts-section-header__eyebrow ts-eyebrow">PageSpeed Performance Optimization</h1>
                    <h2 class="ts-display3">Lightning fast WordPress</h2>
                    <p class="ts-headline4 ts-why-google__intro-text">Slow loading sites hurt search rankings and conversions. Let us fix what's slowing you down. Guaranteed.</p>
            ...
            <div class="ts-section__spacer">
              <section class="ts-copy">
                <div class="ts-grid--alternate ts-copy__inner ts-copy--60-40" >
                  <div class="ts-grid__col ts-copy--flipped ts-grid__col--horizontal-center ts-copy__img is-4 is-8--offset is-7__large--offset ts-grid-row-start">
                    <img class="ts-content-grid-image-lower ts-extra-margin" src="/images/content/ts-pagespeed-screen-200x200-opt.svg" alt="When it comes to page loading, time really is money!" />
                  </div>
                  <div class="ts-grid__col is-1__large--offset ts-copy__text is-7 is-6__large ts-grid-row-start">
                    <h3 class="ts-headline3 ts-element-align" id="hyperpress-increases-traffic-conversions">WordPress PageSpeed Optimization</h3>
