define(["./ts-app.js"],function(_tsApp){"use strict";const cdnHost=(0,_tsApp.unsafeCSS)(_tsApp.CDN_HOST_URL);class TSSecurity extends _tsApp.PageViewElement{static get styles(){return[_tsApp.SharedStyles,_tsApp.TsTypographyStyle,_tsApp.TsLayoutStyle,_tsApp.TsGridStyle,_tsApp.TsCard,_tsApp.TsButtonStyle,_tsApp.css`
      :host {
        display: block;
        padding: 0px;
      }
      ...
      `]}render(){(0,_tsApp.updateMetadata)({title:"Security Solutions - Logical Phase",description:"Defense in depth security that protect data and reputations"});return _tsApp.html`
              ...
              <div class="ts-grid__column is-7 is-6__large is-1__large--offset">
                <header class="ts-grid__column is-7 is-6__large is-1__large--offset">
                  <div class="fade-in content-set">
                    ...
                    <p class="ts-headline4 ts-why-google__intro-text">Hacked site restoration and defense in depth security protection for your WordPress site.</p>
