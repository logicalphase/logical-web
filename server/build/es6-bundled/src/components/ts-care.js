define(["./ts-app.js"],function(_tsApp){"use strict";const cdnHost=(0,_tsApp.unsafeCSS)(_tsApp.CDN_HOST_URL);class TSCare extends _tsApp.PageViewElement{static get styles(){return[_tsApp.SharedStyles,_tsApp.TsTypographyStyle,_tsApp.TsLayoutStyle,_tsApp.TsGridStyle,_tsApp.TsCard,_tsApp.TsButtonStyle,_tsApp.css`
      :host {
        display: block;
        padding: 0px;
      }
      ...
      `]}render(){(0,_tsApp.updateMetadata)({title:"WordPress Preventive Care Program - Logical Phase",description:"Complete protection and monitoring for WordPress"});return _tsApp.html`
              ...
              <div class="ts-grid__column is-7 is-6__large is-1__large--offset">
                <header class="ts-grid__column is-7 is-6__large is-1__large--offset">
                  <div class="fade-in content-set">
                    ...
                    <p class="ts-headline4 ts-why-google__intro-text">We take care of maintaining your site so you can focus on your customers.</p>
                    <div class="ts-section-header__link">
                      <a 
                        ...
                        track-metadata-position="banner">Let's maintain your site</a>
                    </div>
                  </div>
                </header>
              </div>
              ...
              <section class="ts-copy">
                <div class="ts-grid--alternate ts-copy__inner ts-copy--60-40 ts-grid-row-start">
                  <div class="ts-grid__col ts-copy--flipped ts-grid__col--horizontal-center ts-copy__img is-4 is-8--offset is-7__large--offset ts-grid-row-start">
                    <img class="ts-content-grid-image" src="/images/content/ts-care-updates-200x200-opt.svg" alt="WordPress Backups, Updates, Security, Monitoring" />
                  </div>
                  <div class="ts-grid__col is-1__large--offset ts-copy__text is-7 is-6__large ts-grid-row-start">
                    <h3 class="ts-headline3 ts-element-align" id="engaging-experiences-regardless-screen-size">Security, Updates, Backups and more</h3>
                    <p>Keeping WordPress, themes, and plugins up-to-date can make anyone anxious. But not updating can open up security vulnerabilities and cause malfunctions.</p>
                    <p>With our WordPress Preventive Care program you'll rest easy knowing your site is maticulously maintained and monitored 24-7 by WordPress experts. Our <strong>WordPress Preventive Care Program</strong> includes 12 months of:</p>
