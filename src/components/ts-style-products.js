...
.ts-products-and-solutions .ts-product-card__title:active, .ts-products-and-solutions .ts-product-card__title:link, .ts-products-and-solutions .ts-product-card__title:visited {
    color: #202124;
...
.ts-products-and-solutions .card-cta-image.blue .card-cta-image__secondary-link:active, .ts-products-and-solutions .card-cta-image.blue .card-cta-image__secondary-link:focus, .ts-products-and-solutions .card-cta-image.blue .card-cta-image__secondary-link:hover, .ts-products-and-solutions .card-cta-image.blue .card-cta-image__secondary-link:visited {
    color: #fff;
}
...
@media(max-width: 599px) {
  .ts-products-home-page #featured-products .ts-product-card__title, .ts-products-home-page .ts-inner-content .ts-footnotes, .ts-products-home-page .ts-inner-content .ts-grid {
    margin-left: -40px;
  }
...
.ts-products-home-page .ts-jump-menu__item:link, .ts-products-home-page .ts-jump-menu__item:visited {
    color: #202124;
}
