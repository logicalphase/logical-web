...
class TSEmergency extends PageViewElement {
  static get styles() {
    return [
      ...
      .hero {
          background: var(--app-light-text-color) url('https://cdn1-themesurgesonslt.netdna-ssl.com/images/header/ts-emergency-header.svg') no-repeat;
