              ...
              <main class="main delayed-fade-in">
                <div class="ts-content-grid-box">
                  <figure class="img-right">
                    <img src="/images/content/ts-security-badguy-200x200-opt.svg" alt="Understanding WordPress Security Threats" />
                  </figure>
                ...
                <div class="ts-content-grid-box">
                  <figure class="img-right">
                    <img src="/images/content/ts-security-response-200x200-opt.svg" alt="WordPress Security Incident Response Team" />
                  </figure>
                ...
                <div class="ts-content-grid-box">
                  <figure class="img-right">
                    <img src="/images/content/ts-security-vaccinated-200x200-opt.svg" alt="HyperDefense Security Protection for WordPress" />
                  </figure>
