...
class TSPagespeed extends PageViewElement {
  ...
  render() {
    updateMetadata({
      ...
      description:
        "We make slow WordPress lightning fast WordPress. Guaranteed"
    });
            ...
            <div class="ts-section__spacer">
              <section class="ts-copy">
                <div class="ts-grid--alternate ts-copy__inner ts-copy--60-40" >
                  ...
                  <div class="ts-grid__col is-1__large--offset ts-copy__text is-7 is-6__large ts-grid-row-start">
                    <h3 class="ts-headline3 ts-element-align" id="logicalphase-increases-traffic-conversions">WordPress PageSpeed Optimization</h3>
