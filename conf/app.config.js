...
module.exports = (production) => ({
  ...
  app: {
    ...
    name: env.APP_NAME || 'HyperPress by Theme Surgeons',

    // Your application description.
    // This will be used as your description meta tag
    description: env.APP_DESCRIPTION || 'We transform web sites and applications into fast, reliable, secure progressive web applications.',
